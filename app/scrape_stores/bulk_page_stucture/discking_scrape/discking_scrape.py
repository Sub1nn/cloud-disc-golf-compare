...
def save_a_page_for_testing():
    ...
    page_url = "https://kiekkokingi.fi/collections/uudet-frisbeegolfkiekot?grid_list=grid-view"
    ...
    with open('app\scrape_stores\discking_scrape\discking_scrape.html', 'w', encoding='utf-8') as file:
        file.write(html_content)

def get_page_data_for_testing():

    #with open('app\scrape_stores\discking_scrape\discking_scrape.html', 'r', encoding='utf-8') as file:
        #html_content = file.read()

    page_url = "https://kiekkokingi.fi/collections/uudet-frisbeegolfkiekot?page=1&grid_list=grid-view"
