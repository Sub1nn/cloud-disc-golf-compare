...
def save_a_page():
    ...
    page_url = "https://www.par3.lv/disku-golfa-inventars/page/1/"

    response = requests.get(page_url)
        
    with open(r'app\scrape_stores\bulk_page_stucture\par3_scrape\par3_normal_page.html', 'w', encoding='utf-8') as file:
        file.write(response.text)

def get_page_data():

    #with open(r'app\scrape_stores\bulk_page_stucture\par3_scrape\par3_normal_page.html', 'r', encoding='utf-8') as file:
        #html_content = file.read()

    page_url = "https://www.par3.lv/disku-golfa-inventars/page/3/"
